...
export const messages = {
  en: {
    ...
    addPriceTypePrompt: "Price type? (gross / net / any):",
    ...
    addHeavyDamagePrompt: "Exclude heavily damaged cars? (yes / no / any):",
    addMaxDamageLevelPrompt: "Maximum damage level? (none / light / moderate / heavy / total_loss / any):",
    addBrandsPrompt: "Enter brands to include, comma-separated (or \"all\"):",
  ...
  ar: {
    ...
    addPriceTypePrompt: "نوع السعر؟ (إجمالي / صافي / أي):",
    ...
    addHeavyDamagePrompt: "استبعاد السيارات المتضررة بشدة؟ (نعم / لا / أي):",
    addMaxDamageLevelPrompt: "الحد الأقصى لمستوى الضرر؟ (none / light / moderate / heavy / total_loss / أي):",
    addBrandsPrompt: "أدخل العلامات التجارية المراد تضمينها، مفصولة بفواصل (أو \"الكل\"):",
